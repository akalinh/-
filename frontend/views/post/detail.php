...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-md-9" style="background-color: rgba(0, 0, 0, 0.5);";>
			...
			<div class="post" style="background-color: rgba(0, 0, 0, 0.5);">
				<div class="title">
				  ...
				  <li class="list-group-item" style="background-color: rgba(0, 0, 0, 0.5);">
					  <form class="form-inline" action="index.php?r=post/index" id="w0" method="get">
						  <div class="form-group" >
						    <input type="text" class="form-control" name="PostSearch[title]" id="w0input" style="background-color: rgba(0, 0, 0, 0.5);" placeholder="按标题">
						  </div>
