...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-3"  style="background-color: rgba(0, 0, 0, 0.5);">
            <div class="searchbox" >
                <ul class="list-group" >
                    <li class="list-group-item"  style="background-color: rgba(0, 0, 0, 0.5);">
                    ...
                    <li class="list-group-item"  style="background-color: rgba(0, 0, 0, 0.5);">
                        <form class="form-inline" action="<?= Yii::$app->urlManager->createUrl(['post/index']);?>" id="w0"  style="background-color: rgba(0, 0, 0, 0.5);" method="get">
                            <div class="form-group">
                                <input type="text" class="form-control" name="PostSearch[title]"  style="background-color: rgba(0, 0, 0, 0.5);" id="w0input" placeholder="按标题">
                            </div>
                            <br/>
                            <br/>
                            <button type="submit" class="btn btn-default"  style="opacity: 0.8;">搜索</button>
                        </form>
